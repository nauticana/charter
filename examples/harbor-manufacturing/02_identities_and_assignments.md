...
| `ASGN-PRIYA-PP-PLN-01` | `HUMAN-PRIYA-SHAH` | Position | `PP-PLN-01` | Occupies | 2024-01-01 to 2025-12-31 |
...
| `ASGN-DQA-PP-PLN-01`, `ASGN-DQA-PP-PLN-02` | `AGENT-PLANNING-DATA-QUALITY` | Position | `PP-PLN-01`, `PP-PLN-02` | Supports | 2026-04-01 onward |
...
- `HUMAN-PRIYA-SHAH` remains active although `ASGN-PRIYA-PP-PLN-01` ended on 2025-12-31; the identity and historical evidence remain intact.
...
An execution record identifies both `AGENT-ORDER-EXCEPTION-COORDINATOR` and the runtime instance that acted, `RT-OEC-PROD-01`, operated by `OU-PLATFORM-OPERATIONS`. A runtime replica, model, API client, session, or credential is not independently treated as the enterprise agent identity.
