...
The current specification release is 1.1.0. Start with the [specification index](spec/README.md); per-release compatibility notes live in [`migration_guide.json`](migration_guide.json) and the reference SDK's conformance claims in [`conformance/claims/`](conformance/claims/).
