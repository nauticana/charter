...
Status: core-model profile active with twenty-four semantic rules; agent-runtime profile active with eight runtime-behavioral rules and system-adapter profile with four, both run against the reference SDK by default.
