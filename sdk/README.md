...
Status: The reference SDK supports Charter specification 1.1.0 and schema catalogue 2.1.0. Every package is tested against the Harbor instances and the conformance fixtures; the optional Keel adapter targets keel v1.2.64.
