...
Status: Version 1.0.4; every package is tested against the Harbor instances and the conformance fixtures, and the optional Keel adapter targets keel v1.2.64. The supported Charter specification and schema catalogue remain at 1.0.0.
